...
<?php include "header.php" ?>
    <form method="post" action="includes/login.inc.php" style="background-color: rgba(30,40,51,0.82);">
        <h2 class="sr-only">Login Form</h2><label style="margin-left: 63px;">Welcome Back!&nbsp;</label>
